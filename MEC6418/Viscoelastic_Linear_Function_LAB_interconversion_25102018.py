...
# It's the same function. The differences is just in importing data. I wrote this file just for lab
...
#print('Testing Fumctions')
#
#print('''Interconversion of linearly viscoelastic material functions expressed as Prony series: a closure''')
#print('''           Jacques Luk-Cyr, Thibaut Crochon, Chun Li, Martin Lévesque''')
#
#print('C(t) --------------> S(t)')
...
#
#(alpha, betha)=alphai_bethai_for_S2_or_C2(Cn)
#(alpha0, betha0)= alphs0_betha0_for_S0_or_C0(C0)
##
